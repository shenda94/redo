      ...
      <div class="col-md-12">
        <div class="login-box">
          <div class="login-box-body">
            <p class="login-box-msg">Verifikasi Kode</p>
            <div class="form-group">
              <form name="formverifikasi" id="formverifikasi" onsubmit="return false;">
                ...
                <div class="form-group has-feedback">
                  <!----- username -------------->
                  <input class="form-control" placeholder="Kode Verifikasi" id="kode" type="text" name="kode" autocomplete="off" required />
                  <span style="display:none;font-weight:bold; position:absolute;color: red;position: absolute;padding:4px;font-size: 11px;background-color:rgba(128, 128, 128, 0.26);z-index: 17;  right: 27px; top: 5px;" id="span_loginid"></span>
                  <!---Alredy exists  ! -->
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-green btn-block btn-flat" id="btnveri" name="btnveri">Verifikasi Kode</button>
                  </div>
                </div>
              </form>
            </div>
